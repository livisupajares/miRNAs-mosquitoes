...
length(unique(aal_mirna$mirna_name)) # 120
...
# Total number of unique miRNAs
length(unique(aal_mirna_mat_subset$mirna_name)) # 120
...
# Total number of unique miRNAs
length(unique(aal_mirna_mat_denv$mirna_name)) # 62
...
# Total number of unique miRNAs
length(unique(aal_mirna_mat_denv_up$mirna_name)) # 28
