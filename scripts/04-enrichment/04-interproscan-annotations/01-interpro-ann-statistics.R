...
# ==== SAVE DFS ====
write.csv(interpro_clean$aae_all, file = "results/02-enrichment/06-interpro-annotation/aae_all_interpro.csv", row.names = FALSE)
write.csv(interpro_clean$aae_all_down, file = "results/02-enrichment/06-interpro-annotation/aae_all_down_interpro.csv", row.names = FALSE)
write.csv(interpro_clean$aae_per_mirna, file = "results/02-enrichment/06-interpro-annotation/aae_per_mirna_interpro.csv", row.names = FALSE)
write.csv(interpro_clean$aae_per_mirna_down, file = "results/02-enrichment/06-interpro-annotation/aae_per_mirna_down_interpro.csv", row.names = FALSE)
write.csv(interpro_clean$aal_all, file = "results/02-enrichment/06-interpro-annotation/aal_all_interpro.csv", row.names = FALSE)
write.csv(interpro_clean$aal_per_mirna, file = "results/02-enrichment/06-interpro-annotation/aal_per_mirna_interpro.csv", row.names = FALSE)
