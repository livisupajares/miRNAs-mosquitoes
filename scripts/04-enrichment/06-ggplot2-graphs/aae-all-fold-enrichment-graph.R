...
all |>
  filter(species == "Aedes aegypti", category_of_interest == "immune") |>
  ...
  rename_y_axis_labels(new_names = c("Regulation of receptor signaling pathway via JAK-STAT" = "JAK-STAT signaling pathway")) |>
