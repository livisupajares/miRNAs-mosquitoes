...
full_expanded_all_down_stringdb_annotated <- full_expanded_all_down_stringdb_annotated %>%
  select(-gene_primary)
full_expanded_all_stringdb_annotated <- full_expanded_all_stringdb_annotated %>% select(-gene_primary)
full_expanded_per_mirna_down_stringdb_annotated <- full_expanded_per_mirna_down_stringdb_annotated %>%
  select(-gene_primary)
full_expanded_per_mirna_stringdb_annotated <- full_expanded_per_mirna_stringdb_annotated %>% select(-gene_primary)
...
# Save data
write.csv(full_expanded_all_down_stringdb_annotated, file = "results/02-enrichment/04-enrich-full-anotation/output_annotation/full-expanded-all-down-stringdb_annotated.csv", row.names = FALSE)

write.csv(full_expanded_all_stringdb_annotated, file = "results/02-enrichment/04-enrich-full-anotation/output_annotation/full-expanded-all-stringdb_annotated.csv", row.names = FALSE)

write.csv(full_expanded_per_mirna_down_stringdb_annotated, file = "results/02-enrichment/04-enrich-full-anotation/output_annotation/full-expanded-per-mirna-down-stringdb_annotated.csv", row.names = FALSE)

write.csv(full_expanded_per_mirna_stringdb_annotated, file = "results/02-enrichment/04-enrich-full-anotation/output_annotation/full-expanded-per-mirna-stringdb_annotated.csv", row.names = FALSE)
